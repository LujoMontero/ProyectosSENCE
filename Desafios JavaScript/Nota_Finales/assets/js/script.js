...
let NotaHtml1 = parseFloat(prompt("Ingrese la Nota 1"));
let NotaHtml2 = parseFloat(prompt("Ingrese la Nota 2"));
let NotaHtml3 = parseFloat(prompt("Ingrese la Nota 3"));
...
let NotaCss1 = parseFloat(prompt("Ingrese la Nota 1"));
let NotaCss2 = parseFloat(prompt("Ingrese la Nota 2"));
let NotaCss3 = parseFloat(prompt("Ingrese la Nota 3"));
...
let NotaJs1 = parseFloat(prompt("Ingrese la Nota 1"));
let NotaJs2 = parseFloat(prompt("Ingrese la Nota 2"));
let NotaJs3 = parseFloat(prompt("Ingrese la Nota 3"));
